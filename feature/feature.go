...
const (
	...
	// AutoControllerPrincipalCreator will create AWSClusterControllerPrincipal instance that allows all namespaces to use it.
	// owner: @sedefsavas
	// alpha: v0.6
	AutoControllerPrincipalCreator featuregate.Feature = "AutoControllerPrincipalCreator"
)
...
var defaultCAPAFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	AutoControllerPrincipalCreator: {Default: true, PreRelease: featuregate.Alpha},
}
