...
func IdentityAssumeRolePolicy(principalID string) *iamv1.PolicyDocument {
	return assumeRolePolicy(iamv1.PrincipalAWS, []string{principalID})
}

func assumeRolePolicy(principalType iamv1.PrincipalType, principalIDs []string) *iamv1.PolicyDocument {
	return &iamv1.PolicyDocument{
		Version: iamv1.CurrentVersion,
		Statement: []iamv1.StatementEntry{
			{
				Effect:    iamv1.EffectAllow,
				Principal: iamv1.Principals{principalType: principalIDs},
